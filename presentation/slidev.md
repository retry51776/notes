...
- Example to embed QR code with `<img src="https://api.qrserver.com/v1/create-qr-code/?size=260x260&data=Some String Here" />`
...
- Use Tailwind css classes to position elements
