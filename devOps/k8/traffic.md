# Traffic
>
> We are talking about k8s Traffic & its sub components [Service, Ingress, IngressController, External LoadBalancer, coreDNS, kube-proxy] and its link to Deployment, Daemonset, Pods; ServiceMesh is beyond basic Traffic control, so go to the [advanced traffic guide](./k8_adv.md) to learn more.
...
![Kubernetes service port flow](./../../static/k8s-service-port.png)
...
| LoadBalancer | --- | `cluster_ip:host_port=service_port` | `public_ip:host_port` |
