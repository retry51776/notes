...
## Analogy
Old way orchestration is similar to strip mall;
Kubernetes is similar to Shopping Mall;
...
>> **Daemonset** (Building requirements) `Ex: every building must have emergency exit, information desk, hallway. Similar Node requires logging, traffic control, metric, disk mount`
>
